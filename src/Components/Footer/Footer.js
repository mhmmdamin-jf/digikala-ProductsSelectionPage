  ...
  return (
    <div className='d-flex flex-column mt-4'>
      ...
      <div className='row bg-100 justify-content-center'>
        ...
        {/* <Footer_co image={'images/اسمارتک.svg' } />
            <Footer_co image={'images/خدمات ویژه دیجی‌کالا برای کاربران با اشتراک دیجی‌پلاس.svg' } />
            <Footer_co image={'images/ثبت آگهی خرید و فروش آنلاین بدون پادرمیانی!.svg' } />
            <Footer_co image={'images/خدمات ویژه دیجی‌کالا برای کاربران با اشتراک دیجی‌پلاس.svg' } />
            <Footer_co image={ 'images/خرید آنلاین مد و لباس از فروشگاه اینترنتی دیجی‌استایل با همان تجربه از دیجی‌کالا.svg'} />
            <Footer_co image={ 'images/خرید آنی سوپرمارکتی از فروشگاه های نزدیک.svg'} />
            <Footer_co image={ 'images/دیجی کلاب باشگاه مشتریان دیجیکالا.svg'} />
            <Footer_co image={ 'images/دیجی‌فای.svg'} />
            <Footer_co image={'images/دیجی‌کالا بیزینس.svg' } />
            <Footer_co image={ 'images/دیجی‌کالا سرویس.svg'} />
            <Footer_co image={ 'images/دیجیکالا مهر - زنجیره مهربانی و لبخند.svg'} />
            <Footer_co image={ 'images/سیستم حمل و نقل دیجی‌کالا.svg'} />
            <Footer_co image={ 'images/کمدا اپلیکیشنی برای خرید و فروش.svg'} />
            <Footer_co image={ 'images/گنجه.svg'} />
            <Footer_co image={ 'images/مجله اینترنتی دیجی‌کالا مگ.svg'} />
            <Footer_co image={ 'images/مرکز نوآوری و فناوری گروه دیجی‌کالا.svg'} />
            <Footer_co image={ 'images/مگنت - پلتفرم بررسی و انتخاب کالا.svg'} />
            <Footer_co image={ 'images/مجله اینترنتی دیجی‌کالا مگ.svg'} /> */}
        {other_co.map(co => <Footer_co image={co} />)}
        {/* <div className='col-auto p-4 border-bottom border-end border-start footer3-img text-center'>
    
              <a className='m-4'>
                <img src='images/اسمارتک.svg'></img>
              </a>
            </div>
            <div className='col-auto p-4 px-2 border-bottom border-end border-start footer3-img text-center'>
              <a className='m-4'>
                <img src='images/خدمات ویژه دیجی‌کالا برای کاربران با اشتراک دیجی‌پلاس.svg'></img>
              </a>
            </div>
            <div className='col-auto p-4 px-2 border-bottom border-end border-start footer3-img text-center'>
              <a className='m-4'>
                <img src='images/ثبت آگهی خرید و فروش آنلاین بدون پادرمیانی!.svg'></img>
              </a>
            </div>
            <div className='col-auto p-4 px-2 border-bottom border-end border-start footer3-img text-center'>
              <a className='m-4'>
            ...
            <div className='col-auto  p-4 px-2 border-bottom border-end border-start footer3-img text-center'>
              <a className='m-4'>
                <img src='images/خرید آنلاین مد و لباس از فروشگاه اینترنتی دیجی‌استایل با همان تجربه از دیجی‌کالا.svg'></img>
              </a>
            </div>
            <div className='col-auto  p-4 px-2 border-bottom border-end border-start footer3-img text-center'>
              <a className='m-4'>
                <img src='images/خرید آنی سوپرمارکتی از فروشگاه های نزدیک.svg'></img>
              </a>
            </div>
            <div className='col-auto  p-4 px-2 border-bottom border-end border-start footer3-img text-center'>
              <a className='m-4'>
                <img className='img' src='images/دیجی کلاب باشگاه مشتریان دیجیکالا.svg'></img>
              </a>
            </div>
            <div className='col-auto  p-4 px-2 border-bottom border-end border-start footer3-img text-center'>
              <a className='m-4'>
                <img src='images/دیجی‌فای.svg'></img>
              </a>
            </div>
            <div className='col-auto  p-4 px-2 border-bottom border-end border-start footer3-img text-center'>
              <a className='m-4'>
                <img src='images/دیجی‌کالا بیزینس.svg'></img>
              </a>
            </div>
            <div className='col-auto  p-4 px-2 border-bottom border-end border-start footer3-img text-center'>
              <a className='m-4'>
                <img src='images/دیجی‌کالا سرویس.svg'></img>
              </a>
            </div>
            <div className='col-auto  p-4 px-2 border-bottom border-end border-start footer3-img text-center'>
              <a className='m-4'>
                <img src='images/دیجیکالا مهر - زنجیره مهربانی و لبخند.svg'></img>
              </a>
            </div>
            <div className='col-auto  p-4 px-2 border-bottom border-end border-start footer3-img text-center'>
              <a className='m-4'>
                <img src='images/سیستم حمل و نقل دیجی‌کالا.svg'></img>
              </a>
            </div>
            <div className='col-auto  p-4 px-2 border-bottom border-end border-start footer3-img text-center'>
              <a className='m-4'>
                <img src='images/کمدا اپلیکیشنی برای خرید و فروش.svg'></img>
              </a>
            </div>
            <div className='col-auto  p-4 px-2 border-bottom border-end border-start footer3-img text-center'>
              <a className='m-4'>
                <img src='images/گنجه.svg'></img>
              </a>
            </div>
            <div className='col-auto  p-4 px-2 border-bottom border-end border-start footer3-img text-center'>
              <a className='m-4'>
                <img src='images/مجله اینترنتی دیجی‌کالا مگ.svg'></img>
              </a>
            </div>
            <div className='col-auto  p-4 px-2 border-bottom border-end border-start footer3-img text-center'>
              <a className='m-4'>
                <img src='images/مرکز نوآوری و فناوری گروه دیجی‌کالا.svg'></img>
              </a>
            </div>
            <div className='col-auto  p-4 px-2 border-bottom border-end border-start footer3-img text-center'>
              <a className='m-4 '>
                <img className='' src='images/مگنت - پلتفرم بررسی و انتخاب کالا.svg'></img>
              </a>
            </div> */}
